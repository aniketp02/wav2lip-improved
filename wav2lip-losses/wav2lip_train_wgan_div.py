...
def train(device, model, disc, train_data_loader, test_data_loader, optimizer, disc_optimizer,
    ...
    while global_epoch < nepochs:
        ...
        for step, (x, indiv_mels, mel, gt) in prog_bar:
            ...
            # Real images
            real_validity = disc(gt)
            # Fake images
            fake_validity = disc(g.detach())
            # Gradient penalty
            gradient_penalty = compute_gradient_penalty(disc, gt.detach(), g.detach())
            # Adversarial loss
            ...
            prog_bar.set_description('L1: {}, Sync: {}, Percep: {}, Disc {}'.format(running_l1_loss / (step + 1),
...
def eval_model(test_data_loader, global_step, device, model, disc):
    ...
    running_sync_loss, running_l1_loss, running_disc_loss, running_perceptual_loss = [], [], [], []
    while 1:
        for step, (x, indiv_mels, mel, gt) in enumerate((test_data_loader)):
            ...
            running_disc_loss.append(d_loss.item())
        ...
        print('L1: {}, Sync: {}, Percep: {}, Disc: {}'.format(sum(running_l1_loss) / len(running_l1_loss),
